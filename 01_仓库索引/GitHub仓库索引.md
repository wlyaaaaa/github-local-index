...
| wlyaaaaa/ai-cli-profile-manager | PUBLIC | main | E:\Projects\Tools\ai-cli-profile-manager | `main` 已同步，`0/0`，脏工作区 2 项（cached） | 公开仓库先做暴露面审查，再按显式路径提交 |
...
| wlyaaaaa/Key | PRIVATE | main | V:\Personal\Projects\Key | `main` 已同步，`0/0`，脏工作区 1 项（cached） | 私有仓库按备份需求确认后提交 |
...
| wlyaaaaa/PCConfig | PRIVATE | main | E:\PCConfig | `main` 已同步，`0/0`，脏工作区 39 项（cached）<br>`codex/personalos-shadow-root-fact` 由 PersonalOS 外部 owner 治理，不纳入 Codex 收敛判断（cached） | 私有仓库按备份需求确认后提交<br>无；由 PersonalOS owner 管理 |
