...
| wlyaaaaa/github-local-index | PUBLIC | main | E:\GitHub总索引 | `main` 已同步，`0/0`，脏工作区 3 项（cached） | 公开仓库先做暴露面审查，再按显式路径提交 |
...
| wlyaaaaa/PCConfig | PRIVATE | main | E:\PCConfig | `main` 已同步，`0/0`，脏工作区 2 项（cached） | 私有仓库按备份需求确认后提交 |
