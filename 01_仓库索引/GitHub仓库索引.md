...
| --- | --- | --- | --- | --- | --- |
| wlyaaaaa/.agents | PRIVATE | master | E:\.agents | `codex/consolidate-personal-capabilities` 已同步，`0/0`，脏工作区 1 项 | 私有仓库按备份需求确认后提交 |
...
| wlyaaaaa/HealthLongevity | PRIVATE | main | E:\Projects\Decisions\HealthLongevity | `main` ahead/behind `1/0` | 私有备份策略放行，可推送 |
