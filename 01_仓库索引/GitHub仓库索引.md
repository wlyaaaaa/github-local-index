...
| wlyaaaaa/ai-cli-profile-manager | PUBLIC | main | E:\Projects\Tools\ai-cli-profile-manager | `main` 已同步，`0/0`，脏工作区 53 项（cached） | 公开仓库先做暴露面审查，再按显式路径提交 |
...
| wlyaaaaa/legal-filing-kit | PRIVATE | main | E:\Projects\Tools\legal-filing-kit<br>V:\Personal\Worktrees\legal-filing-kit-1.0-audit-87dcfd1<br>V:\Personal\Worktrees\legal-filing-kit-1.0-reaudit-859b083<br>V:\Personal\Worktrees\legal-filing-kit-s3-audit-25529a0 | `main` ahead/behind `2/0`（cached）<br>历史审计快照固定于 `87dcfd1`，detached 且无 upstream，不自动同步（cached）<br>历史审计快照固定于 `859b083`，detached 且无 upstream，不自动同步（cached）<br>历史审计快照固定于 `25529a0`，detached 且无 upstream，不自动同步（cached） | 保持提交固定审计快照；需要新证据时创建新审计副本<br>私有备份策略放行，可推送 |
| wlyaaaaa/llm-backend-toolkit | PUBLIC | main | V:\Personal\Projects\llm-backend-toolkit | `main` 已同步，`0/0`，脏工作区 36 项（cached） | 公开仓库先做暴露面审查，再按显式路径提交 |
