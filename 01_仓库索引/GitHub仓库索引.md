...
当前 `wlyaaaaa` 账号共有 29 个仓库。本文件由 `tools/Update-GitHubIndex.ps1` 刷新。
...
| wlyaaaaa/github-local-index | PUBLIC | main | E:\GitHub总索引 | `main` 已同步，`0/0`，脏工作区 15 项（cached） | 公开仓库先做暴露面审查，再按显式路径提交 |
...
| wlyaaaaa/PCConfig | PRIVATE | main | E:\PCConfig | `main` 已同步，`0/0`（cached） | 正常维护 |
...
| wlyaaaaa/TimeAudit | PUBLIC | main | E:\Projects\Tools\TimeAudit<br>E:\TimeAudit\.claude\worktrees\agitated-cray-6fe115<br>E:\TimeAudit\.claude\worktrees\competent-gates-0601f9<br>E:\TimeAudit\.claude\worktrees\condescending-banach-39c34b | `codex/full-audit-hardening-docs` 已同步，`0/0`（cached）<br>prunable worktree（路径缺失）（cached）<br>prunable worktree（路径缺失）（cached）<br>prunable worktree（路径缺失）（cached） | 清理或恢复 prunable worktree 元数据<br>正常维护 |
