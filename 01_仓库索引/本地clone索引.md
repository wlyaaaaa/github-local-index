...
| wlyaaaaa/github-local-index | E:\GitHub总索引<br>V:\Personal\Worktrees\github-index-s9-wp4-owner-closeout<br>V:\Personal\Worktrees\github-index-s9-wp4-release | `main` 已同步，`0/0`，脏工作区 11 项（cached）<br>`codex/s9-wp4-owner-closeout` 无 upstream（cached）<br>`codex/s9-wp4-release` 无 upstream（cached） |
| wlyaaaaa/Key | V:\Personal\Projects\Key | `main` 已同步，`0/0`（cached） |
| wlyaaaaa/legal-filing-kit | E:\Projects\Tools\legal-filing-kit<br>V:\Personal\Worktrees\legal-filing-kit-1.0-audit-87dcfd1<br>V:\Personal\Worktrees\legal-filing-kit-1.0-reaudit-859b083<br>V:\Personal\Worktrees\legal-filing-kit-s3-audit-25529a0 | `codex/v2-s5-ai-facade` 已同步，`0/0`，脏工作区 3 项（cached）<br>历史审计快照固定于 `87dcfd1`，远端领先 2，不自动同步（cached）<br>历史审计快照固定于 `859b083`，远端领先 1，不自动同步（cached）<br>历史审计快照固定于 `25529a0`，远端领先 5，不自动同步（cached） |
| wlyaaaaa/llm-backend-toolkit | V:\Personal\Projects\llm-backend-toolkit<br>V:\Personal\Worktrees\llm-backend-toolkit-cache-review-25d2794<br>V:\Personal\Worktrees\llm-backend-toolkit-cache-review-4bd5081<br>V:\Personal\Worktrees\llm-backend-toolkit-cache-review-df3f17d<br>V:\Personal\Worktrees\llm-backend-toolkit-explicit-cache-key<br>V:\Personal\Worktrees\llm-backend-toolkit-job-input-integrity<br>V:\Personal\Worktrees\llm-backend-toolkit-observer-gui | `main` 已同步，`0/0`（cached）<br>历史审计快照固定于 `25d2794`，detached 且无 upstream，不自动同步（cached）<br>历史审计快照固定于 `4bd5081`，detached 且无 upstream，不自动同步（cached）<br>历史审计快照固定于 `df3f17d`，detached 且无 upstream，不自动同步（cached）<br>`codex/explicit-cache-key-identity` 无 upstream（cached）<br>`codex/job-input-integrity` 无 upstream（cached）<br>`codex/model-observer-gui` ahead/behind `0/1`（cached） |
