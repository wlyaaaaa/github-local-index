...
| 仓库 | 分支状态 | 原因 |
| --- | --- | --- |
| wlyaaaaa/.agents | `codex/consolidate-personal-capabilities` 已同步，`0/0`，脏工作区 7 项 | 脏工作区 7 项 |
| wlyaaaaa/LocalOCR | `main` 已同步，`0/0`，脏工作区 18 项 | 脏工作区 18 项 |
| wlyaaaaa/TimeAudit | `codex/full-audit-hardening-docs` 已同步，`0/0`，脏工作区 2 项 | 脏工作区 2 项 |
