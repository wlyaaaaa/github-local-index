...
$aiCoachRecommendation = Get-RepositoryTaskRecommendation -NameWithOwner 'wlyaaaaa/ai-coach' -LocalPath 'G:\20_Projects\github\ai-coach' -Visibility 'PRIVATE' -ExistingTaskHints @()
$steamRecommendation = Get-RepositoryTaskRecommendation -NameWithOwner 'wlyaaaaa/steam-millennium-config-backup' -LocalPath 'E:\Projects\Tools\steam-millennium-config-backup' -Visibility 'PUBLIC' -ExistingTaskHints @()
$steamCoveredRecommendation = Get-RepositoryTaskRecommendation -NameWithOwner 'wlyaaaaa/steam-millennium-config-backup' -LocalPath 'E:\Projects\Tools\steam-millennium-config-backup' -Visibility 'PUBLIC' -ExistingTaskHints @('SteamMillenniumConfigSnapshot')
